...
INSERT INTO team_members (id, name, role, bio, photo, display_order) VALUES
  ('t1', 'Dr. Sarah Chen', 'Founder & Director', 'Animal lover and community advocate with 15 years of experience in animal welfare. Dr. Chen founded AdoptPaws with a mission to create lasting bonds between pets and families.', 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=400&h=400&fit=crop', 1),
  ('t2', 'Michael Rodriguez', 'Adoption Coordinator', 'Former veterinary assistant passionate about finding perfect matches for our pets. Michael brings expertise in animal behavior and family counseling to every adoption.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop', 2),
  ('t3', 'Emily Watson', 'Veterinary Care Manager', 'Licensed veterinary technician with a decade of experience. Emily ensures all our animals receive top-quality medical care and are healthy before adoption.', 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=400&h=400&fit=crop', 3),
  ('t4', 'James Park', 'Community Outreach Director', 'Dedicated to building partnerships and educating the community about responsible pet ownership. James organizes adoption events and volunteer programs.', 'https://images.unsplash.com/photo-1566492031773-4f4e44671857?w=400&h=400&fit=crop', 4),
  ('t5', 'Lisa Thompson', 'Foster Program Manager', 'Coordinates our network of foster families who provide temporary homes for animals. Lisa has personally fostered over 100 animals in her career.', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&h=400&fit=crop', 5),
  ('t6', 'David Kim', 'Operations Manager', 'Handles daily operations and facility management. David ensures our shelter runs smoothly and provides the best environment for our animals.', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&h=400&fit=crop', 6)
...
INSERT INTO products (
  ...
  (
    ...
    'https://images.unsplash.com/photo-1552053831-71594a27632d?q=80&w=1324&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'New York',
  ...
  (
    ...
    'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1400&q=80',
    'Queens',
    'Spayed, vaccinated',
    'Calm, independent',
    'cats',
  ...
  (
    ...
    'https://images.unsplash.com/photo-1570018144715-43110363d70a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1376&q=80',
    NULL,
    NULL,
    NULL,
    'cats',
  ...
  (
    ...
    'https://images.unsplash.com/photo-1541599540903-216a46ca1dc0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1471&q=80',
    NULL,
    NULL,
    NULL,
    'special-needs',
